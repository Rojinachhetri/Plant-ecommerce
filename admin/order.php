            ...
            <table class="table container">
                ...
                <tbody>
                    <?php
                     ...
                     orders.product_id, orders.status, orders.customer_id, customers.payment_method, 
                     orders.order_amount, products.title, products.image, 
                     customers.full_name, customers.address
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td colspan='2'>
                               ...
                               <br> <a href='scripts/order_delivered.php?id=".$row['id']."'><button class='btn btn-success'>Delivered</button></a>
                            </td>";
                        echo "</tr>";
                    }
