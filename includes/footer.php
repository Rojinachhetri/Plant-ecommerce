            ...
            <div class="col-sm-6 col-lg-2">
                <div class="single_footer_part">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="">Succulents & Cacti</a></li>
                        <li><a href="">Air Plants</a></li>
                        <li><a href="">Small Indoor Plants</a></li>
                        <li><a href="">Flowering Indoor Plants</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6 col-lg-2">
                ...
                <div class="col-lg-8">
                    <div class="copyright_text">
                        <p>
                            ...
                            <a href="" target="_blank">BCA5th sem</a>
                        </p>
                    </div>
                </div>
                <div class="col-lg-4">
