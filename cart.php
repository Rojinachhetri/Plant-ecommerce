...
while($row = mysqli_fetch_array($result)){
    echo '<tr>
            ...
            <td>
                <div class="product_count d-flex align-items-center btn-group">
                    <input type="number" name="quantity" value="'.$row['qty'].'" min="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <a href="./scripts/cart_increment.php?id=' . $row['id'] . '"><button type="button">+</button></a>
                    <a href="./scripts/cart_decrement.php?id=' . $row['id'] . '"><button type="button">-</button></a>
                    <a href="./scripts/cart_remove.php?id='.$row['id'].'&qty=1" ><button type="button">&#10005;</button></a></div>
            </td>
            <td>
