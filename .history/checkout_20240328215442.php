            ...
            <div class="col-lg-8">
                <div class="billing_details">
                    ...
                    <form class="contact_form" id="checkoutForm" action="address.php" method="post" >
                        ...
                        <button onclick="Echeckout()" name="checkoutEsewa"  class="btn_1">Esewa payment</button>
                        <button onclick="checkoutkhalti()" name="checkoutkhalti" id="payment-button" class="fs-2 text-light border-0 px-2 rounded-pill bg-danger">Pay with Khalti</button>
...
function checkoutkhalti() {
    // Set the payment method
    document.getElementById("payment_method").value = "checkoutkhalti";
