...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Example:
     $stmt = $conn->prepare("INSERT INTO customers (first_name, phone_number, email, address, city, district, zip, country) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
     $stmt->bind_param("sssssssss", $firstName, $phoneNumber, $email, $address, $city, $district, $zip, $country);
    $stmt->execute();
     $stmt->close();
