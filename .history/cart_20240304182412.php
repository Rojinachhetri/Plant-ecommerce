    ...
    echo '<tr>
            ...
            <td>
                <div class="product_count d-flex align-items-center">
                    <input type="number" name="quantity" value="'.$row['qty'].'" min="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    
                    <a href="./scripts/cart_increment.php?id=' . $row['id'] . '"><button type="button" class="btn btn-outline-danger">&#10005;>+</button></a>
                    <a href="./scripts/cart_decrement.php?id=' . $row['id'] . '"><button type="button" class="btn btn-outline-danger">&#10005;>-</button></a>
                    <a href="./scripts/cart_remove.php?id='.$row['id'].'&qty=1" ><button type="button" class="btn btn-outline-danger">&#10005;</button></a></div>
            </td>
            <td>
