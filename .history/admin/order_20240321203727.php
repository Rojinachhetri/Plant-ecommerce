    ...
    <div class="allContainer">
        ...
        <div class="container">
            <table class="table container">
                ...
                <tbody>
                    <?php
                     $query = 'SELECT orders.id, orders.order_date, 
                     orders.product_id, orders.status, orders.user_id,customers.payment_,method
                      orders.order_amount, products.title, products.image, 
                      users.first_name, users.last_name FROM `orders`, 
                      `products`, `users`,`customers` where orders.product_id=products.id
                       and orders.user_id=users.id order by id';
