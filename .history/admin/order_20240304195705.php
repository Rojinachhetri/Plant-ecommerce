        ...
        <div class="container">
            <table class="table container">
                ...
                <tbody>
                    ...
                    <?php
                    $query = 'SELECT orders.id, orders.order_date, orders.product_id, orders.status, orders.user_id, orders.order_amount, products.title, products.image, users.first_name, users.last_name, shipping.shipping_address 
                    FROM `orders`,`products`,`users`,`shipping` where 
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo"<td>.$row['shi[[ing_address'] .</td>
