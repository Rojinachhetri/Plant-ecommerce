...
$data = [
    ...
    'psc' => 0,
    'txAmt' => 0,
    'tAmt' => $sum + 49 * $quantity, // Total amount
    'pid' => 'products.id',
    'scd' => 'EPAYTEST',
...
<section class="checkout_area padding_top">
  <div class="container">
    ...
    <form action="https://uat.esewa.com.np/epay/main" method="POST">
        ...
        <input id="checkoutButton" type="button" value="Proceed to eSewa Payment">
    </form>
    </div>
...
<script>
  document.getElementById("checkoutButton").addEventListener("click", function() {
    // Submit the form to address.php
    document.getElementById("checkoutForm").submit();
    
    // Redirect to eSewa page after form submission
