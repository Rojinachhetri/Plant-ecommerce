...
$data =[
    ...
    'fu'=>'http://localhost:8080/Plant/failed.php?q=fu'
];
...
<section class="checkout_area padding_top">
    ...
    <input value="<?php echo $data['sum'];?>" name="amt" type="hidden">
    <input value="0" name="txAmt" type="hidden">
    <input value="0" name="psc" type="hidden">
    <input value="<?php echo $data['delivery_charge'];?>" name="pdc" type="hidden">
    <input value="EPAYTEST" name="scd" type="hidden">
    <input value="<?php echo $data['user_id'];?>" name="pid" type="hidden">
