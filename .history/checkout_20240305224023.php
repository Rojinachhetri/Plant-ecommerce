...
<section class="checkout_area padding_top">
  <div class="container">
    ...
    <input value="<?php echo $sum + 49 * $quantity ?>" name="tAmt" type="hidden">
    <input value="<?php echo $sum ?>" name="amt" type="hidden"> <!-- Ensure this line is correctly set -->
    <input value="0" name="txAmt" type="hidden">
    <input value="0" name="psc" type="hidden">
    <input value="<?php echo $quantity * 49 ?>" name="pdc" type="hidden"> <!-- Ensure this line is correctly set -->
    <input value="EPAYTEST" name="scd" type="hidden">
    <input value="<?php echo $user_id ?>" name="pid" type="hidden"> <!-- Ensure this line is correctly set -->
    <input value="http://localhost/Plant/confirmation.php?q=su" type="hidden" name="su">
    <input value="http://localhost/Plant/failed.php?q=fu" type="hidden" name="fu">
