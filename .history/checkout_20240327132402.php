                    ...
                    <form class="contact_form" id="checkoutForm" action="address.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group p_star">
                                ...
                                <small class="text-danger"><?php echo $numberErr; ?></small>
                            </div>
                            <div class="col-md-6 form-group p_star">
                            ...
                            <div class="col-md-12 form-group p_star">
                                <input type="text" class="form-control" id="add1" name="address" placeholder="
...
<script>
    function Echeckout() {
        ...
        document.getElementById("checkoutForm").submit(); // Submit the form after setting the value
    }
