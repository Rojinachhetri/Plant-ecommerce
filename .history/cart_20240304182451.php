    ...
    echo '<tr>
            ...
            <td>
                <div class="product_count d-flex align-items-center">
                    ...
                    <a href="./scripts/cart_increment.php?id=' . $row['id'] . '"><button type="button" class="btn btn-outline">&#10005;>+</button></a>
                    <a href="./scripts/cart_decrement.php?id=' . $row['id'] . '"><button type="button" class="btn btn-outline">&#10005;>-</button></a>
