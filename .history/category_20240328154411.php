...
<section class="cat_product_area section_padding">
    <!-- Category product section HTML code -->
    <div class="container">
        <!-- Container div for products -->
        <div class="row align-items-center latest_product_inner">
            <?php
            // Display products based on the filtered query
            $result = mysqli_query($con, $query);
...
<script>
    // JavaScript code for category filtering
    $(document).ready(function () {
        // Add event listener to category links
        $('.category-link').click(function (e) {
            e.preventDefault();
            var category = $(this).data('category');
            window.location.href = 'yourpage.php?category=' + category; // Replace 'yourpage.php' with your actual page URL
        });
    });
</script>
