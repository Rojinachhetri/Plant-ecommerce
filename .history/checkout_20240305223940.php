...
<section class="checkout_area padding_top">
  <div class="container">
    ...
    <input value="Rs. <?php echo $sum + 49 * $quantity ?>" name="tAmt" type="hidden">
    <input value="Rs. <?php echo $sum ?>" name="amt" type="hidden">
    <input value="0" name="txAmt" type="hidden">
    <input value="0" name="psc" type="hidden">
    <input value="Rs. <?php echo $quantity * 49 ?>" name="pdc" type="hidden"> 
