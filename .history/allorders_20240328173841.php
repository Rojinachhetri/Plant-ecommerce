...
$user_id = $_SESSION['user_id'];
 $query = 'SELECT products.price, products.id, products.title, products.image, customers.customer_id from customers, products where products.customer_id = customers.customer_id ;
