...
<section class="login_part padding_top">
    <div id="error-container" style="display: none; color: red;"></div> <!-- Error message container -->
    <div class="container">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_form">
                    <div class="login_part_form_iner">
                        <h3>Welcome to Our Store! Please Sign Up Now</h3>
                        <form class="row contact_form" id="registration-form" action="scripts/signup_script.php" method="post">
...
<script>
    ...
    var phoneRegex = /^9\d{9}$/; // Regex for phone number starting with '9' and having 10 digits
    var errorMessage = "";
    ...
    if (mobile === "") {
        ...
        errorMessage += "Mobile number should start with '9' and be exactly 10 digits long.\n";
    }
