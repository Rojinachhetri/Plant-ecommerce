...
You have commented out the JavaScript code that handles form submission via AJAX. If you don't intend to use AJAX for form submission, it's okay to leave it as is. But if you want to use AJAX, you should uncomment and properly configure that section of the code.

You have an extra backtick () at the end of the closing </div>` tag in the HTML section where the order box is defined. You should remove it.

In the SQL query to insert data into the customers table, you're using backticks (`) around the column values. Instead, you should use single quotes (').

Let's address these issues and clean up the code:
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($con, $sql)) {
        ...
        echo "<script>alert('Shipping data submitted successfully!');</script>";
        // Clear form fields if needed
        echo "<script>document.querySelector('.contact_form').reset();</script>";
    } else {
