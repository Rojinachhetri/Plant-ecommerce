...
// Initialize variables for total amount and delivery charges
$total_amount = 0;
$delivery_charge_per_qty = 49; // Delivery charge per quantity of a product
                    ...
                    <div class="order_details_iner">
                        ...
                        if ($result) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                $order_amount = $row['price'] * $row['qty'] + ($delivery_charge_per_qty * $row['qty']);
