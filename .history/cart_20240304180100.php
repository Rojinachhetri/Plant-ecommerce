    ...
    echo '<tr>
            ...
            <td>
                <div class="product_count d-flex align-items-center">
                    ...
                    <a href="scripts/cart_increment.php?id=<?php echo $row['product_id']; ?>"><button type="button">+</button></a>
                    <a href="scripts/cart_decrement.php?id=<?php echo $row['product_id']; ?>"><button type="button">-</button></a>   
                 </div>
            </td>
            <td>
