...
$user_id = $_SESSION['user_id'];
 $query = 'SELECT products.price, products.id, products.title, products.image, cart.qty,customer_id from cart, ,customers,products where products.id = cart.product_id and cart.user_id="' . $user_id . '"';
