                                ...
                                '<tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="product_count d-flex align-items-center">
                                            <input type="number" name="quantity" value="<?php echo $row['qty']; ?>" min="1">
                                            <a href="scripts/cart_increment.php?id=<?php echo $row['id']; ?>"><button type="button">+</button></a>
                                            <a href="scripts/cart_decrement.php?id=<?php echo $row['id']; ?>"><button type="button">-</button></a>
                                        </div>
                                    </td>
                                    </td>
                                    <td>
